...
public class WorldGenEvents {
    ...
    public static void generateOres(BiomeLoadingEvent event) {
        ...
        if (category != Biome.Category.NETHER && category != Biome.Category.THEEND) {
            ...
            features.add(() -> Feature.ORE.withConfiguration(new OreFeatureConfig(GRAVEL, Registering.PLATINUM_GRAVEL_ORE.BLOCK.get().getDefaultState(), 9)).range(64).square().func_242731_b(20));
            features.add(() -> Feature.ORE.withConfiguration(new OreFeatureConfig(GRAVEL, Registering.RUTHENIUM_GRAVEL_ORE.BLOCK.get().getDefaultState(), 9)).range(64).square().func_242731_b(20));
            features.add(() -> Feature.ORE.withConfiguration(new OreFeatureConfig(GRAVEL, Registering.IRIDIUM_GRAVEL_ORE.BLOCK.get().getDefaultState(), 9)).range(64).square().func_242731_b(20));
            features.add(() -> Feature.ORE.withConfiguration(new OreFeatureConfig(GRAVEL, Registering.ZIRCONIUM_GRAVEL_ORE.BLOCK.get().getDefaultState(), 9)).range(64).square().func_242731_b(20));
        }
    }
}
