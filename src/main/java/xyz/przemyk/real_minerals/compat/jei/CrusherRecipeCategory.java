...
public class CrusherRecipeCategory implements IRecipeCategory<CrusherRecipe> {
    ...
    public void draw(CrusherRecipe recipe, MatrixStack matrixStack, double mouseX, double mouseY) {
        ...
        TranslationTextComponent timeString = new TranslationTextComponent("gui.jei.category.smelting.time.seconds", 5);
        Minecraft minecraft = Minecraft.getInstance();
        FontRenderer fontRenderer = minecraft.fontRenderer;
        int stringWidth = fontRenderer.getStringPropertyWidth(timeString);
        fontRenderer.func_243248_b(matrixStack, timeString, (float)(this.background.getWidth() - stringWidth), 45F, -8355712);
    }
