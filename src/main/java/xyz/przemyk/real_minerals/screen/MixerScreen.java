...
public class MixerScreen extends MachineScreen<MixerContainer> {
    ...
    public MixerScreen(MixerContainer screenContainer, Inventory inventory, Component title) {
        ...
        screenModules.add(new TankModule(7, 7, 18, 72, this, menu.blockEntity.fluidTank.firstInput));
        screenModules.add(new TankModule(48, 7, 18, 72, this, menu.blockEntity.fluidTank.secondInput));
        screenModules.add(new TankModule(109, 7, 18, 72, this, menu.blockEntity.fluidTank.output));
